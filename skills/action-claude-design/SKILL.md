...
This project has no `AGENTS.md`. If the user wants persistent instructions for every chat in this project, they can create a `AGENTS.md` file at the project root — only the root is read; subfolders are ignored.
