...
Use `$skill-generate-2d-sprite` when the map needs reusable transparent props. Choose one of two approaches:
...
```bash
python skills/skill-generate-2d-map/scripts/compose_layered_preview.py \
