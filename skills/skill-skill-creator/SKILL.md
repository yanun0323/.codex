...
```bash
python3 skills/skill-skill-creator/scripts/init_skill.py <name> --kind <command|rule|skill> --path <skills-root>
```

Useful variants:

```bash
python3 skills/skill-skill-creator/scripts/init_skill.py interface-design-audit --kind command --path skills --resources scripts,references,assets
python3 skills/skill-skill-creator/scripts/init_skill.py global --kind rule --path skills
python3 skills/skill-skill-creator/scripts/init_skill.py doc-coauthoring --kind skill --path skills --interface short_description="Draft and refine documentation"
```

For existing catalogs, normalize all folders:

```bash
ruby skills/skill-skill-creator/scripts/normalize_skill_catalog.rb
```
...
```bash
python3 skills/skill-skill-creator/scripts/generate_openai_yaml.py <path/to/skill-folder> --interface display_name="..." --interface short_description="..."
```
...
```bash
python3 skills/skill-skill-creator/scripts/quick_validate.py <path/to/skill-folder>
